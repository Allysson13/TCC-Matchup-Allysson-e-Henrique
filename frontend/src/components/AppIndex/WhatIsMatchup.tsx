        ...
        <div>
          <Grid container spacing={5} sx={{marginBottom: '100px'}}>
            <Grid item xs={12} md={4}>
              <Box sx={item}>
                <Box sx={number}>1.</Box>
                  <SportsEsportsOutlinedIcon sx={{width: '80px', height: '80px', marginTop: '15px', marginBottom: '15px'}}/>
            ...
            <Grid item xs={12} md={4}>
              <Box sx={item}>
                <Box sx={number}>2.</Box>
                  <GroupAddOutlinedIcon sx={{width: '80px', height: '80px', marginTop: '15px', marginBottom: '15px'}}/>
                <Typography variant="h5" align="center">
